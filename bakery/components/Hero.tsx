  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=1800&q=85')" }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <a
            href="#meni"
            className="inline-flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-500 text-white font-medium px-5 py-2.5 rounded-full transition-all duration-200 hover:shadow-xl hover:shadow-amber-600/40 hover:-translate-y-0.5 cursor-pointer text-sm"
          >
          ...
          <a
            href="#kontakt"
            className="inline-flex items-center justify-center gap-2 glass-dark text-white font-medium px-5 py-2.5 rounded-full transition-all duration-200 hover:bg-white/20 hover:-translate-y-0.5 cursor-pointer text-sm border border-white/20"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
