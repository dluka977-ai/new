          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Wolt dostava"
                className="w-10 h-10 rounded-full bg-stone-800 hover:bg-[#009DE0] flex items-center justify-center transition-colors duration-200 cursor-pointer"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
